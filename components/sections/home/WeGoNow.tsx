        ...
        <div className="rounded-[12px] md:rounded-[32px] bg-surface px-6 py-8 md:px-16 md:py-16 lg:px-20">
          <div className="flex items-end justify-between gap-6 mb-6 md:mb-16">
            <div>
              ...
              <Reveal>
                <h2 className="mt-3 font-display font-bold text-[26px] md:text-[36px] lg:text-[44px] leading-[1.1] tracking-[-1px]">
                  WeGo Now.
                </h2>
              </Reveal>
            </div>
            <Link
              href="/news"
              className="inline-flex items-center gap-2 text-[14px] md:text-[14px] font-semibold tracking-normal hover:text-brand transition-colors"
            >
              모든 소식 보기
              <ArrowRight size={14} />
            </Link>
              ...
              <Reveal key={n.slug} delay={i * 0.08}>
                ...
                >
                  ...
                  >
                    ...
                    <h3 className="mt-3 md:mt-5 text-[16px] md:text-[16px] font-semibold leading-[1.5] tracking-normal text-foreground line-clamp-2 group-hover:text-brand transition-colors">
                      {n.title}
                    </h3>
